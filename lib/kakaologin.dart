...
import 'package:lovepet/Home.dart';
...
class _LoginResultState extends State {
  ...
  checkAccount(String username) async {
    ...
    var responsee =
        await http.post(Uri.http("13.209.92.180", "signup/"), body: body);

    var imsilogin = await http.post(
        Uri.http("13.209.92.180", "api/v2/auth/token/login/"),
    ...
    if (imsilogin.statusCode == 200) {
      ...
      var userresponse = await http.get(
          Uri.http("13.209.92.180", "api/v2/auth/users/me"),
